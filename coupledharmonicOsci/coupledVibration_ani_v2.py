...
fig = plt.figure()
ax = fig.add_subplot(111, xlabel='x position [m]', xlim=(0, L), ylim=(-L/4, L))
ax.grid()
...
def update(i):              # ここのiは下のframes=np.arange(0, len(t))に対応した引数になっている
    line1.set_data([0, l1, l1 + l2, L], [0, x1[i], x2[i], 0])
    line2.set_data([0, L/2 + q1[i]], [20, 20])
    line3.set_data([0, L/2 + q2[i]], [40, 40])
...
ani.save('./gif/coupledVibration_v2.gif', writer='pillow', fps=fps)